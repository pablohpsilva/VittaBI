...
app.get('/people-protected-against-flu', function (req, res) {
    const data = [
...
app.get('/children-protected-against-poliomielite', function (req, res) {
    const data = [
...
app.get('/flu-per-month', function (req, res) {
    const data = [
